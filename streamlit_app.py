...
def transform_data():
    ...
    df = pd.read_excel('https://github.com/rgriggs0072/streamlit-example/raw/master/SAVEMART_DISTRIBUTION_GRID_RGSR.xlsx', engine='openpyxl')
    ...
    df_melted.to_csv('https://github.com/rgriggs0072/streamlit-example/raw/master/SAVEMART_DISTRO_GRID_RGSR_1.csv', index=False, encoding='utf-8')
